...
using Xamarin.Forms;
using Xamvvm;
using static Cp.SimpleGalleryPageModel;

namespace Cp
{
    public partial class BuyandsellPage : ContentPage, IBasePage<BuyandsellModel>
    {
        public BuyandsellPage()
        {
